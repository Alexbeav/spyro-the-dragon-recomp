...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "SPYRO_THE_DRAGON_RECOMP_PROJECT_ROOT",
    .build_dir_env = "SPYRO_THE_DRAGON_RECOMP_BUILD_DIR",
    .force_setup_env = "SPYRO_THE_DRAGON_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCES_014.38_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Spyro_the_Dragon__Recompiled",
    .prepare_note =
