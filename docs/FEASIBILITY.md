# Spyro the Dragon feasibility binding

## Identity

- Title and region: Spyro the Dragon, Europe.
- Serial: SCES-01438.
- Source executable path: `disc/SCES_014.38`.
- Load address: `0x80010000`.
- Entry point: `0x80060D10`.
- Source disc binding: `disc/Spyro the Dragon (Europe, Australia) (En,Fr,De,Es,It).cue`.
...
The clean source commit is `2290468e6d9c3fe58b342c5ece16b432448d8fe4`. It uses PSXRecomp
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `2290468e6d9c3fe58b342c5ece16b432448d8fe4`.
- Portfolio `spyro-the-dragon/BUILDINFO.json`.
- Portfolio `spyro-the-dragon/RECEIPT.md`.
